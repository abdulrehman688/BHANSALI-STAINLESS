...
export default function FloatingContact() {
  ...
  const buttons = [
    ...
    {
      id: "whatsapp",
      href: "https://wa.me/919876543210?text=Hi%2C%20I%20need%20a%20quote%20for%20SS%20flanges",
      label: "WhatsApp",
      bg: "#25D366",
      icon: (
    ...
    >
      {buttons.map((btn) => (
        <a
          ...
          className="flex items-center text-white overflow-hidden transition-all duration-300 shadow-lg"
          style={{
            background: btn.bg,
            width: hovered === btn.id ? "160px" : "48px",
            height: "48px",
        ...
        >
          ...
          <span
            ...
            style={{ opacity: hovered === btn.id ? 1 : 0 }}
          >
            {btn.label}
          </span>
        </a>
